...
SerialPort = "COM5"; %% Change to the port connected to the Arduino
...
g1 = [7 7.4];    % GOAL [x y]  15.6 17.8  1.5 18.5
g2 = [11.5 3.4];    % GOAL [x y]  13.4 9     8.6 14.7
%%Assigning Pose if randomPose == false
Pose = [2 4 0*pi/180] %[2 4 0*pi];    %Pose [x y theta]
%% Do not Modify
